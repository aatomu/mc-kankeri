tp @e[type=armor_stand,tag=Kankeri.Can.Master,limit=1] ~ ~10 ~
...
execute store result entity @e[type=armor_stand,tag=Kankeri.Can.Master,limit=1] Motion[2] double 0.15 run data get entity @e[type=item,nbt={Item:{id:"minecraft:knowledge_book",tag:{isCanMotioner:1b}}},limit=1] Motion[2] 100
