...
execute if score *GameTimer Kankeri.System >= *TimerYellowTick Kankeri.System run bossbar set kankeri:time name [{"text":"","color":"green","bold": true},{"text":"残り時間 "},{"score":{"name": "*TimerMin","objective": "Kankeri.System"}},{"text":":"},{"selector":"@e[type=armor_stand,tag=Kankeri.Can.Master,limit=1]"},{"score":{"name": "*TimerSec","objective": "Kankeri.System"}},{"text":" 進捗率:"},{"score":{"name": "*KickCount","objective": "Kankeri.System"}},{"text": "/"},{"score":{"name": "*PlayerCount","objective": "Kankeri.System"}},{"text":"回"}]
execute if score *GameTimer Kankeri.System < *TimerYellowTick Kankeri.System run bossbar set kankeri:time color yellow
execute if score *GameTimer Kankeri.System < *TimerYellowTick Kankeri.System run bossbar set kankeri:time name [{"text":"","color":"yellow","bold": true},{"text":"残り時間 "},{"score":{"name": "*TimerMin","objective": "Kankeri.System"}},{"text":":"},{"selector":"@e[type=armor_stand,tag=Kankeri.Can.Master,limit=1]"},{"score":{"name": "*TimerSec","objective": "Kankeri.System"}},{"text":" 進捗率:"},{"score":{"name": "*KickCount","objective": "Kankeri.System"}},{"text": "/"},{"score":{"name": "*PlayerCount","objective": "Kankeri.System"}},{"text":"回"}]
execute if score *GameTimer Kankeri.System < *TimerRedTick Kankeri.System run bossbar set kankeri:time color red
execute if score *GameTimer Kankeri.System < *TimerRedTick Kankeri.System run bossbar set kankeri:time name [{"text":"","color":"red","bold": true},{"text":"残り時間 "},{"score":{"name": "*TimerMin","objective": "Kankeri.System"}},{"text":":"},{"selector":"@e[type=armor_stand,tag=Kankeri.Can.Master,limit=1]"},{"score":{"name": "*TimerSec","objective": "Kankeri.System"}},{"text":" 進捗率:"},{"score":{"name": "*KickCount","objective": "Kankeri.System"}},{"text": "/"},{"score":{"name": "*PlayerCount","objective": "Kankeri.System"}},{"text":"回"}]
##ボスバーに数値を反映
...
execute if score *KickInterval Kankeri.System matches 1.. at @e[type=armor_stand,tag=Kankeri.Can.Master] as @a[team=Kankeri.Player,gamemode=survival,nbt={HurtTime:8s},distance=..2.5] at @s on attacker if entity @s[team=Kankeri.Hunter] as @p run function kankeri:system/bind
##勝利判定
...
execute if score *KickInterval Kankeri.System matches 1.. at @e[type=armor_stand,tag=Kankeri.Can.Master] run effect give @a[team=Kankeri.Player,distance=..2.5] glowing 1 0 true
execute if score *KickInterval Kankeri.System matches 1.. at @e[type=armor_stand,tag=Kankeri.Can.Master] run effect clear @a[team=Kankeri.Player,distance=2.5..3] glowing
